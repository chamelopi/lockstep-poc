...
namespace Server
{
    ...
    public class GameScene : Scene
    {
        ...
        void HandleRemoteCommand(NetworkPacket packet)
        {
            ...
            {
                Debug.Log($"ERROR: Received command for past turn: {commandPacket.Command.TargetTurn}. Discarding it.");
                return;
            }

            if (commandPacket.PlayerId != commandPacket.PlayerId)
            {
                Debug.Log($"ERROR: Received command for player {commandPacket.PlayerId} from player {commandPacket.PlayerId}!");
                return;
            }
